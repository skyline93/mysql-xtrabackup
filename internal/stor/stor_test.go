...
func TestIndex(t *testing.T) {
	...
	node1, _ := col.NewNode(uuid.New().String(), []byte("/node1"), true)
	node2, _ := col.NewNode(uuid.New().String(), []byte("/node2"), false)
	node3, _ := col.NewNode(uuid.New().String(), []byte("/node3"), false)
	node4, _ := col.NewNode(uuid.New().String(), []byte("/node4"), true)
	node5, _ := col.NewNode(uuid.New().String(), []byte("/node5"), false)
	node6, _ := col.NewNode(uuid.New().String(), []byte("/node6"), false)
